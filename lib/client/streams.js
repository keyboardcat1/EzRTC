...
exports.RTCHTMLMediaStream = exports.RTCMediaStream = exports.HTMLMediaStream = void 0;
/**
 * A utility abstraction over a `MediaStream` and a HTML media element linked and automatically configured
 */
class HTMLMediaStream extends MediaStream {
    constructor(element, streamtracks) {
        super(streamtracks);
...
exports.HTMLMediaStream = HTMLMediaStream;
/**
